...
def attack(char_name: str, char_class: str) -> str:
    """Расчитывает урон исходя из выбранного класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Расчитывает защиту исходя из выбранного класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применяет специальный прием в зависимости от класса."""
    if char_class == 'warrior':
        return (f'{char_name}'
...
def choice_char_class() -> str:
    """Запускает выбор персонажа."""
    approve_choice: str = None
    char_class: str = None
    char_class_allowed: bool = False
    while approve_choice != 'y':
        if char_class_allowed is False:
